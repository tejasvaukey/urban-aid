...
export default function Navbar() {
  ...
  return (
    <>
      <nav className=" py-4 px-24 h-20 w-full fixed z-40 text-white">
        <header className="flex justify-between items-center  px-3 py-2 rounded-full bg-white bg-opacity-10 backdrop-blur-sm ">
          <div className="flex items-center justify-start w-1/5">
            ...
            />
            <h4 className="font-bold tracking-wide text-blue-950 text-2xl leading-none shadoww">
              Urban Aid
            </h4>
          </div>
          ...
          <div className="flex justify-end gap-5 items-center w-1/5 font-semibold ">
            ...
            {isLoggedIn ? (
              ...
              <button className="border-2 border-white px-4 py-1 rounded-full bg-white hover:bg-transparent text-black hover:text-white">
                Log In
              </button>
            )}
          </div>
